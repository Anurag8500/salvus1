...
export default function DonationHistory() {
  const donations = [
    {
      campaign: 'Kerala Flood Relief 2024',
      amount: 2500,
      date: 'Dec 15, 2024',
      usageStatus: 'Utilized',
      statusColor: 'text-accent',
      statusBg: 'bg-accent/10',
      statusBorder: 'border-accent/30',
      icon: CheckCircle,
    },
    {
      campaign: 'Cyclone Michaung Response',
      amount: 1500,
      date: 'Dec 10, 2024',
      usageStatus: 'In Progress',
    ...
    {
      campaign: 'Uttarakhand Landslide Relief',
      amount: 3000,
      date: 'Dec 5, 2024',
      usageStatus: 'Utilized',
      statusColor: 'text-accent',
